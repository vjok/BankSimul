...
QT_MOC_LITERAL(1, 9, 8), // "sendPage"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 11) // "receivePage"

    },
    "DLLMySQL\0sendPage\0\0receivePage"
};
...
void DLLMySQL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DLLMySQL *_t = static_cast<DLLMySQL *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendPage(); break;
        case 1: _t->receivePage(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DLLMySQL::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLMySQL::sendPage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DLLMySQL::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DLLMySQL.data,
      qt_meta_data_DLLMySQL,  qt_static_metacall, nullptr, nullptr}
};
